                    ...
                    <div>
                        <form action="" method="post" class="formName">
                            <table class="tables">
                                ...
                                <tr>
                                    <td><label style="font-weight: normal;">apk文件</label></td>
                                    <td><span>*</span></td>
                                    <td>
                                        <a href="" class="delete" style="color: #0f0f0f;border: 0px;">下载</a>
                                        <a href="" class="delete" style="color: #0f0f0f;border: 0px;">删除</a>
                                    </td>
                                </tr>
                            </table>
                        </form>
