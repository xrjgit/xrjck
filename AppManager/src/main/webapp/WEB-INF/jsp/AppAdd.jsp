...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="forName">
                <div class="tdName">
                    新增APP基础信息<i class="fa fa-user fa-fw"></i>测试账户001
                </div>
                <div>
                    <form action="" method="post" class="formName">
                        <table class="tables">
                            ...
                            <tr>
                                <td><label for="gName" style="font-weight: normal;">LOGO图片</label></td>
                                <td><span>*</span></td>
                                <td><input type="file" name="" class="inputs" id="gName"></td>
                            </tr>
                        </table>
