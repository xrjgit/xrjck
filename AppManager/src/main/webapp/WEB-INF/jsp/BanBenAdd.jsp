                        ...
                        <form action="" method="post" class="formName">
                            <table class="tables">
                                <tr>
                                    ...
                                    <td><span>*</span></td>
                                    <td><input type="text" name="" class="inputs" id="oName" placeholder="请输入版本号"/></td>
                                </tr>
                                <tr>
                                    <td><label for="yName" style="font-weight: normal;">版本大小</label></td>
                                    <td><span>*</span></td>
                                    <td><input type="text" name="" class="inputs" id="yName" placeholder="请输入版本大小，单位为Mb"/></td>
                                </tr>
                                <tr>
                                    <td><label for="zName" style="font-weight: normal;">发布状态</label></td>
                                    <td><span>*</span></td>
                                    <td><input type="text" name="" class="inputs" id="zName" placeholder="预发布"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span>*</span></td>
                                    <td><input type="file" name="" class="inputs" id="kName"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
